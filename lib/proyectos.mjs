...
// El mapa de `config.proyectos` indexa por nombre de carpeta, pero las carpetas se llaman
// distinto segun la maquina: `Aurora` en la PC principal es `aurora-retreat` en la
// notebook. Los `alias` de cada proyecto resuelven esa diferencia, y la busqueda ignora
// mayusculas.
